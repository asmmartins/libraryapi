...
using Xunit;
using GroupDomain = Library.Domain.Groups;
using PublicSchoolDomain = Library.Domain.PublicSchools;
using VO = Library.Domain.Shared.ValueObjects;

namespace Library.Tests.Unit.Domain.Groups
{
